...
// Sofra - Sales Overview Chart Data (last 7 days, EGP)
const sofraSalesChartData = {
  labels: ["Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
  datasets: [
    {
      label: "Sales (EGP)",
      backgroundColor: colorLib(window.chartColors.green).alpha(0.6).rgbString(),
      borderColor: window.chartColors.green,
      borderWidth: 2,
      borderRadius: 6,
      data: [2800, 3200, 2600, 3400, 3900, 4100, 4500],
    },
  ],
};

// Sofra - Reports: Sales Summary (last 6 months, EGP)
const sofraReportsSalesData = {
  labels: ["Mar", "Apr", "May", "Jun", "Jul", "Aug"],
  datasets: [
    {
      label: "Sales (EGP)",
      borderColor: window.chartColors.blue,
      backgroundColor: colorLib(window.chartColors.blue).alpha(0.15).rgbString(),
      borderWidth: 2,
      tension: 0.4,
      fill: true,
      pointRadius: 3,
      data: [15200, 17800, 19600, 21100, 22700, 24500],
    },
  ],
};

// Sofra - Reports: Best Selling Meals
const sofraReportsMealsData = {
  labels: ["Mixed Grill", "Grilled Chicken", "Beef Shawarma", "Seafood Pasta", "Koshari"],
  datasets: [
    {
      data: [32, 27, 21, 12, 8],
      backgroundColor: [
...
function initCharts() {
  // Sofra Reports - Sales Summary
  setTimeout(function () {
    getOrCreateChart("reports-sales-chart", {
      type: "line",
      data: sofraReportsSalesData,
      options: {
        responsive: true,
  ...
  // Sofra Reports - Best Selling Meals
  setTimeout(function () {
    getOrCreateChart("reports-meals-chart", {
      type: "doughnut",
      data: sofraReportsMealsData,
      options: {
        responsive: true,
        maintainAspectRatio: false,
        plugins: {
  ...
  // Sofra Sales Overview Chart
  setTimeout(function () {
    getOrCreateChart("sofra-sales-chart", {
      type: "bar",
      data: sofraSalesChartData,
      options: {
        responsive: true,
        maintainAspectRatio: false,
        plugins: {
